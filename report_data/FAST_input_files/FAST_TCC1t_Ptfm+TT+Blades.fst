...
---------------------- INPUT FILES ---------------------------------------------
"Modules/ElastoDyn_FAST_Ptfm+TT+Blades.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
"unused"    BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"unused"    BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"unused"    BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"Modules/InflowWind_12.4mps_turbulent.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
...
"Modules/HydroDyn_3.07Hs_9.10Tp_1.0PkShp.dat"    HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
